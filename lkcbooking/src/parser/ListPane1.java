...
/**
 * A list panel for select items for create invoice pdf form 
 * @author guangyang
 */
...
public class ListPane1 extends GList
{
	private static final long serialVersionUID = GUIWidgetAdaptor.serialVersionUID;

	InvoiceDlg parentDlg;
	
	public ListPane1(InvoiceDlg dlg, Vector<String> data) {
		super(data);
		parentDlg = dlg;
